...
if island == 'Biscoe':
    ...
    island_dream = 1
elif island_torgerson == 'Torgerson':
    island_torgerson = 1
...
new_prediction = rfc.predict([[bill_length, bill_depth, flipper_length, body_mass, island_biscoe, island_dream, island_torgerson, sex_feamle, sex_male]])
